                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('front/img/doctors/doctors-1.jpg') }}" class="img-fluid" alt=""></div>
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('front/img/doctors/doctors-2.jpg') }}" class="img-fluid" alt=""></div>
                            <div class="member-info">
                                <h4>Sarah Jhonson</h4>
                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('front/img/doctors/doctors-3.jpg') }}" class="img-fluid" alt=""></div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-6 mt-4">
                        <div class="member d-flex align-items-start">
                            <div class="pic"><img src="{{ asset('front/img/doctors/doctors-4.jpg') }}" class="img-fluid" alt=""></div>
                            <div class="member-info">
                                <h4>Amanda Jepson</h4>
                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('front/img/gallery/gallery-1.jpg') }}" class="venobox" data-gall="gallery-item">
                                <img src="{{ asset('front/img/gallery/gallery-1.jpg') }}" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('front/img/gallery/gallery-2.jpg') }}" class="venobox" data-gall="gallery-item">
                                <img src="{{ asset('front/img/gallery/gallery-2.jpg') }}" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('front/img/gallery/gallery-3.jpg') }}" class="venobox" data-gall="gallery-item">
                                <img src="{{ asset('front/img/gallery/gallery-3.jpg') }}" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('front/img/gallery/gallery-4.jpg') }}" class="venobox" data-gall="gallery-item">
                                <img src="{{ asset('front/img/gallery/gallery-4.jpg') }}" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('front/img/gallery/gallery-5.jpg') }}" class="venobox" data-gall="gallery-item">
                                <img src="{{ asset('front/img/gallery/gallery-5.jpg') }}" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('front/img/gallery/gallery-6.jpg') }}" class="venobox" data-gall="gallery-item">
                                <img src="{{ asset('front/img/gallery/gallery-6.jp') }}g" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('front/img/gallery/gallery-7.jpg') }}" class="venobox" data-gall="gallery-item">
                                <img src="{{ asset('front/img/gallery/gallery-7.jpg') }}" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4">
                        <div class="gallery-item">
                            <a href="{{ asset('front/img/gallery/gallery-8.jpg') }}" class="venobox" data-gall="gallery-item">
                                <img src="{{ asset('front/img/gallery/gallery-8.jpg') }}" alt="" class="img-fluid">
                            </a>
                        </div>
                    </div>
